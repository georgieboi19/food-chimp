...
    <div class="ui-block-a">
  <div class="centerElement"><h2><?php echo $arrayp['prodName']?></h2>
    <h3>£<?php echo $arrayp['prodPrice']?></h3>
...
    <input type="checkbox" data-role="flipswitch" data-mini="true" name="flip-checkbox-1" id="flip-checkbox-1">
<label for="flip-checkbox-2">Tue:</label>
    <input type="checkbox" data-role="flipswitch" data-mini="true" name="flip-checkbox-2" id="flip-checkbox-1">
<label for="flip-checkbox-3">Wed:</label>
    <input type="checkbox" data-role="flipswitch" data-mini="true" name="flip-checkbox-3" id="flip-checkbox-1">
<label for="flip-checkbox-4">Thu:</label>
    <input type="checkbox" data-role="flipswitch" data-mini="true" name="flip-checkbox-4" id="flip-checkbox-1">
<label for="flip-checkbox-5">Fri:</label>
    <input type="checkbox" data-role="flipswitch" data-mini="true" name="flip-checkbox-5" id="flip-checkbox-1">
<label for="flip-checkbox-6">Sat:</label>
    <input type="checkbox" data-role="flipswitch" data-mini="true" name="flip-checkbox-6" id="flip-checkbox-1">
<label for="flip-checkbox-7">Sun:</label>
    <input type="checkbox" data-role="flipswitch" data-mini="true" name="flip-checkbox-7" id="flip-checkbox-1">
<div class="ui-grid-a centerElement">
