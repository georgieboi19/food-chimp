  ...
  <div class="centerElement">
    ...
    <div class="ui-grid-a" >
      <div class="ui-block-a">
		...
		<a href="list.php"><img class="centerWidget_dashboard" src="images/order_foo.png"></a>
	  </div>
      <div class="ui-block-b">      
        <a href="favourites.php"><img src="images/view_fav.png"></a>
		<a href="mydishes.php"><img class="centerWidget_dashboard" src="images/offer_foo.png"></a>
      </div>
    </div>
  </div>
	<br>
	<span style="margin-left: 11px"><img width="30px" src="images/dashboardBLACK (4).png">
