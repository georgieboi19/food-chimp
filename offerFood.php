...
$URL="https://georgeharrison-webb.co.uk/mue/uploadphoto.php?insetID=$insetedID";
...
<div role="main" class="ui-content ui-body-b centerElement" data-theme="b">
  ...
  <tr>
	<td><input type="checkbox" value='Shelfish ' name="checkbox-mini-5" id="checkbox-mini-5" data-mini="true" data-theme="b"><label for="checkbox-mini-5">Shelfish</label></td>
  </tr>
  <tr>
 ...
 <tr>
	  <td style="padding-top: 10px; color: black;">Availability:</td>
  </tr>
	  
  <tr>
    <td>
		<table style='border: 5px; color: black;' >
		<tr>
			<td>Mon:</td>
			<td><input type="checkbox" data-role="flipswitch" name="flip-checkbox-1" id="flip-checkbox-1" data-theme="b"></td>
		</tr>
		<tr>
			<td>Tue:</td>
			<td><input type="checkbox" data-role="flipswitch" name="flip-checkbox-2" id="flip-checkbox-1" data-theme="b"></td>
		</tr>
		<tr>
			<td>Wed:</td>
			<td><input type="checkbox" data-role="flipswitch" name="flip-checkbox-3" id="flip-checkbox-1" data-theme="b"></td>
		</tr>
		<tr>
			<td>Thu:</td>
			<td><input type="checkbox" data-role="flipswitch" name="flip-checkbox-4" id="flip-checkbox-1" data-theme="b"></td>
		</tr>
		<tr>
			<td>Fri:</td>
			<td><input type="checkbox" data-role="flipswitch" name="flip-checkbox-5" id="flip-checkbox-1" data-theme="b"></td>
		</tr>
		<tr>
			<td>Sat:</td>
			<td><input type="checkbox" data-role="flipswitch" name="flip-checkbox-6" id="flip-checkbox-1" data-theme="b"></td>
		</tr>
		<tr>
			<td>Sun:</td>
			<td><input type="checkbox" data-role="flipswitch" name="flip-checkbox-7" id="flip-checkbox-1" data-theme="b"></td>
		</tr>
		</table>
   	</td>
   </tr>
   ...
   <tr>
  	<td style="padding-top: 15px"><input type=submit value='Next' name=submit></td>
   </tr>
